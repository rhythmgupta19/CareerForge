...
// Ensure unique combination of user, level, and module (allows one level-level assessment and one per topic)
userAssessmentProgressSchema.index({ userId: 1, levelId: 1, moduleId: 1 }, { unique: true });
